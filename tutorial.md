...
**Tutorial-Version 0.0.10, Stand 12.09.2026**
...
1. Lass den vorhandenen Gate-Block stehen.
2. Öffne das Dropdown.
3. Ändere **X** zu **Y**.
4. Drücke **Taste A** mehrmals.

**Was solltest du sehen?** Wieder jedes Mal `1`. X und Y führen beide vom Nordpol zum Südpol, aber über unterschiedliche Drehachsen.
...
Da das Qubit in `|0⟩` genau auf der Z-Achse startet, verändert diese Drehung die direkte Wahrscheinlichkeit für `0` und `1` nicht.
...
**Was solltest du sehen?** Weiterhin immer `0`.
...
**Was solltest du sehen?** Ungefähr 50 % `0` und 50 % `1`. Bei wenigen Versuchen kann das Verhältnis natürlich etwas abweichen.
...
3. Wähle im Dropdown des zweiten Blocks ebenfalls **H**.
4. Drücke **Taste A** mehrmals.

**Was solltest du sehen?** Wieder immer `0`.
...
**Was solltest du sehen?** Ungefähr 50 % `0` und 50 % `1`.
...
**Was solltest du sehen?** Bei 45° sollte `0` deutlich häufiger erscheinen. Bei 90° ungefähr 50/50. Bei 135° sollte `1` deutlich häufiger erscheinen.
