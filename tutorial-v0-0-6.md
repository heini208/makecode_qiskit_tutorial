...
**Tutorial-Version 0.0.6, Stand 12.09.2026**
...
![X-Gatter auf der Bloch-Kugel](https://raw.githubusercontent.com/heini208/makecode_qiskit_tutorial/main/images/v006_x_gate.gif)

Jetzt probierst du X direkt aus:

1. Öffne **MicroQiskit → Qiskit Grundlagen → Gatter**.
2. Füge den Block **Gatter auf Circuit anwenden** zwischen Circuit-Erstellung und Messung ein.
3. Öffne das Dropdown im Gate-Block.
4. Wähle **X**.
5. Lass **Qubit 0** eingestellt.
6. Drücke **Taste A** mehrmals.
...
**Was solltest du sehen?** Jedes Mal `1`. X dreht `|0⟩` vollständig nach `|1⟩`.

## 6. Das Y-Gatter

Das **Y-Gatter** dreht ebenfalls um 180°, aber um die Y-Achse.

![Y-Gatter auf der Bloch-Kugel](https://raw.githubusercontent.com/heini208/makecode_qiskit_tutorial/main/images/v006_y_gate.gif)

Jetzt probierst du Y aus:

1. Lass den Gate-Block aus dem vorherigen Schritt stehen.
2. Öffne dessen Dropdown.
3. Ändere **X** zu **Y**.
...
**Was solltest du sehen?** Wieder jedes Mal `1`. Auch Y bringt `|0⟩` nach `|1⟩`, nur über eine andere Drehachse.

## 7. Das Z-Gatter

Das **Z-Gatter** dreht um 180° um die Z-Achse. Es verändert vor allem die Phase des Qubits.

Jetzt probierst du Z genauso aus:
...
**Was solltest du sehen?** Weiterhin immer `0`. Das Qubit startet auf der Z-Achse. Eine Drehung um diese Achse verändert die direkte Wahrscheinlichkeit für `0` und `1` nicht.

## 8. Das Hadamard-Gatter

Das **Hadamard-Gatter**, kurz **H**, bringt `|0⟩` in eine gleichgewichtete Superposition.

![Hadamard-Gatter](https://raw.githubusercontent.com/heini208/makecode_qiskit_tutorial/main/images/v006_hadamard_y90_x180.gif)

Jetzt probierst du H aus:
...
**Was solltest du sehen?** Ungefähr 50 % `0` und 50 % `1`. Einzelne kurze Testreihen können etwas davon abweichen.

## 9. Hadamard zweimal

Jetzt probierst du eine Kombination aus zwei Gates aus.

![Zweimal Hadamard](https://raw.githubusercontent.com/heini208/makecode_qiskit_tutorial/main/images/v006_hadamard_then_hadamard.gif)
...
**Was solltest du sehen?** Wieder immer `0`. Zwei H-Gatter hintereinander bringen das Qubit zurück in den Startzustand `|0⟩`.

Entferne danach beide H-Gatter, damit du wieder mit einem leeren Circuit vor der Messung startest.

## 10. RX ausprobieren

Mit dem Rotationsblock kannst du **RX**, **RY** und **RZ** im Dropdown auswählen und zusätzlich einen Winkel einstellen.

![RX mit 90 Grad](https://raw.githubusercontent.com/heini208/makecode_qiskit_tutorial/main/images/v006_rx_pi_2.gif)

Jetzt probierst du RX aus:

1. Öffne **MicroQiskit → Qiskit Grundlagen → Gatter**.
2. Füge den Rotationsblock vor der Messung ein.
3. Öffne das Dropdown im Rotationsblock.
4. Wähle **RX**.
5. Stelle den Winkel auf **90°**.
...
**Was solltest du sehen?** Ungefähr 50 % `0` und 50 % `1`, genau wie bei H. Der Weg auf der Bloch-Kugel ist aber ein anderer.
...
![RY mit 90 Grad](https://raw.githubusercontent.com/heini208/makecode_qiskit_tutorial/main/images/v006_ry_pi_2.gif)
...
![RZ mit 90 Grad](https://raw.githubusercontent.com/heini208/makecode_qiskit_tutorial/main/images/v006_rz_pi_2.gif)
